...
################################################################################
# Sets up the Nimbus node for the simple Storm cluster on GCE. 
#
...
#
main() {
	echo "Nimbus node set up started at "`date`
  ...
  echo "Nimbus node set up done at "`date`  
	return 0
}
